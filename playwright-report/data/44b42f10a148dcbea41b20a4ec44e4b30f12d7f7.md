...
Locator: getByText('AEGO', { exact: true })
Expected: visible
Error: strict mode violation: getByText('AEGO', { exact: true }) resolved to 2 elements:
    1) <span class="text-2xl font-bold tracking-tighter">AEGO</span> aka getByRole('link', { name: 'AEGO' })
    2) <span class="text-xl font-bold tracking-tighter">AEGO</span> aka getByRole('contentinfo').getByText('AEGO', { exact: true })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('AEGO', { exact: true })
